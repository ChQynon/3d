    ...
    <div className="py-2">
      <Tabs defaultValue="basic" className="w-full">
        ...
        <TabsContent value="basic" className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label className="text-white font-mono tracking-normal">Качество</Label>
            ...
            <div className="space-y-2">
              <Label className="text-white font-mono tracking-normal">Формат</Label>
              <Select
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm border-[rgba(255,255,255,0.12)] bg-black/50">
              <div>
                <Label className="text-white font-mono tracking-normal">Использовать Hyper</Label>
                <p className="text-gray-400 text-xs tracking-normal">Лучшие детали</p>
              </div>
              <Switch
            ...
            <div className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm border-[rgba(255,255,255,0.12)] bg-black/50">
              <div>
                <Label className="text-white font-mono tracking-normal">T/A Поза</Label>
                <p className="text-gray-400 text-xs tracking-normal">Для людей</p>
              </div>
        ...
        <TabsContent value="advanced" className="space-y-4">
          <div className="space-y-2">
            <Label className="text-white font-mono tracking-normal">Режим условий</Label>
            <RadioGroup
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="concat" className="text-white tracking-normal">
                  Concat (Один объект, несколько видов)
                </Label>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div className="space-y-2">
            <Label className="text-white font-mono tracking-normal">Материал</Label>
            <RadioGroup
          ...
          <div className="space-y-2">
            <Label className="text-white font-mono tracking-normal">Уровень генерации</Label>
            <RadioGroup
    ...
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="bg-black border-[rgba(255,255,255,0.12)] text-white max-w-md">
          <DialogHeader>
            <DialogTitle className="text-xl text-white font-mono tracking-normal">Настройки</DialogTitle>
          </DialogHeader>
          {content}
        </DialogContent>
      </Dialog>
    ...
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent className="bg-black border-t border-[rgba(255,255,255,0.12)] text-white">
        <div className="mx-auto w-full max-w-md">
          <DrawerHeader>
            <DrawerTitle className="text-xl text-white font-mono tracking-normal">Настройки</DrawerTitle>
          </DrawerHeader>
