    ...
    <UIForm {...form}>
      <form ref={formRef} onSubmit={form.handleSubmit(onSubmit)} className="relative">
        <div
          ref={dropAreaRef}
          className={cn(
            "relative bg-black/80 backdrop-blur-md rounded-[24px] overflow-hidden transition-all shadow-lg border border-[rgba(255,255,255,0.12)] mx-auto",
        ...
        >
          ...
          <div className="px-2 py-1.5">
            <div className="flex items-center">
              ...
              <AutoResizeTextarea
                placeholder="Сгенерировать 3D модель..."
          ...
          {isDragging && (
            <div className="absolute inset-0 bg-black/80 flex items-center justify-center pointer-events-none z-10">
              <p className="text-white font-medium tracking-normal text-lg">Перетащите изображения сюда</p>
            </div>
          )}
        </div>
